    ...
    return new Scaffold(
      ...
      body: new Center(
        child: new Container(
          ...
          child: new Column(
            children: <Widget>[
              new Text('Select a size for your pie:',style: TextStyle(fontSize: 20.0),),
                  ...
                  items: pizza.specials.map((String value) {
                    return new DropdownMenuItem(
                        ...
                        child: new Row(
                          children: <Widget>[
                            new Icon(Icons.cake),
                            new Text('Special: ${value}', style: TextStyle(color: Colors.amber),),
                          ],
                        )
                    );
                  }).toList(),
              ...
              new Text('Select some vegetable toppings:', style: TextStyle(color: Colors.brown),),
                ...
                child: new ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index){
                      return new CheckboxListTile(
                          ...
                          title: new Text(_pizzaOrder.toppings.keys.elementAt(index), style: TextStyle(color: Colors.deepOrangeAccent),),
